...
def segment(image):
    ...
    cluster3 = cluster_image_3[max(0, centers[2][0]-margin):min(64, centers[2][0]+margin), max(0, centers[2][1]-margin):min(64, centers[2][1]+# Reshape all clisters into 28x28
